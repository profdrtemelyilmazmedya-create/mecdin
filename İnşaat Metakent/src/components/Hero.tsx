      ...
      <div className="relative mx-auto flex min-h-[calc(100vh-5rem)] max-w-7xl flex-col justify-end px-4 pb-10 sm:px-6 lg:px-8 lg:pb-16">
        <div className="max-w-3xl">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            ...
            <a
              href="#iletisim"
              className="inline-flex items-center justify-center rounded-md border border-white/20 bg-white/10 px-6 py-3 text-sm font-bold text-white backdrop-blur-md transition hover:bg-white/20"
            >
              İletişime Geç
            </a>
          </div>
        ...
        <div className="mt-12">
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
            {site.highlights.map((item) => (
              <div
                key={item}
                className="glass-panel rounded-md px-4 py-4 text-sm font-semibold text-white/90 transition hover:-translate-y-1 hover:border-ember/40 hover:bg-white/10"
              >
                {item}
              </div>
            ))}
